        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              a passion for turning ideas into interactive digital solutions, 
              I enjoy solving complex problems and continuously learning new 
              technologies to bring creativity and functionality together.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="/HAFSA ETTALHI RESUME.pdf"
                download="/HAFSA ETTALHI RESUME.pdf"
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Designing intuitive interfaces and seamless user 
